...
export const STILE = {
  ...
  superheld: {
    ...
    auftrag:
      ...
      "a sleek modern suit of armoured fabric with a flowing cape, standing " +
      "confidently on a rooftop at dusk with city lights and drifting sparks " +
      "behind. Heroic rim lighting. The chest stays plain, without any emblem " +
      "or marking. " + KEINE_MARKEN + " " + BEWAHREN,
  },
  animation3d: {
