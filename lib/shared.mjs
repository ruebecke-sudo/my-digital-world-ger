...
import { textebeneSVG, copyrightSVG } from "./textlayer.mjs";
...
export function buildPrompt(motif) {
  ...
  return stil + " Szene: " + motif.szene +
    " Die Figur steht rechts im Bild. Die linke Bildhaelfte bleibt ruhig," +
    " dunkel und frei von wichtigen Details, damit dort Platz fuer die" +
    " Typografie bleibt. Der untere Bildrand bleibt frei." +
    " Absolut kein Text im Bild: keine Buchstaben, keine Zahlen, keine" +
    " Woerter, keine Schilder mit Aufschrift, keine Logos, keine Gravuren," +
