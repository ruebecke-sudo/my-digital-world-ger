...
export default function Home() {
  ...
  const leistungen = isDE
    ? [
        ...
        { title: 'Kurzvideos & Reels', text: 'Bewegen Sie Ihre Zielgruppe mit professionellen Social Media Kurzvideos für Instagram, TikTok, Facebook & Co. Dynamischer Schnitt und starke Hooks.', href: '/kurzvideos-reels', cta: 'Mehr Infos' },
    ...
    : [
        ...
        { title: 'Short Videos & Reels', text: 'Engage your target audience with professional short-form social media videos for Instagram, TikTok, Facebook & Co. Dynamic editing and punchy hooks.', href: '/kurzvideos-reels', cta: 'Learn more' },
