            ...
            return (
              ...
              >
                ...
                <div className={!isEven ? 'lg:order-2' : ''}>
                  ...
                  <Link href={leistung.id === 'empfehlungen' ? '/empfehlungen' : (leistung.id === 'comic-stil' ? '/comic-stil' : (leistung.id === 'videos' ? '/kurzvideos-reels' : '/programme'))}>
