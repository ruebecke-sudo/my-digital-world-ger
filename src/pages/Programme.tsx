...
const programme: Programme[] = [
  ...
  },
  {
    ...
    popup: {
      ...
      cta: 'Synthesia kostenlos starten',
      infoLink: 'https://mdw-synthesia.netlify.app/',
    },
  },
  {
    name: 'Creatify Lab',
  ...
  {
    name: 'Figma Weave',
    beschreibung: 'Nahtlose Integration und kollaboratives Design-Tool zur Erstellung interaktiver Benutzeroberflächen, Design-Systeme und moderner Vektorgrafiken.',
    link: 'https://figma.com',
    kategorie: 'No-Code',
    katColor: 'bg-orange-500/10 text-orange-400 border-orange-500/20',
    popup: {
      badge: 'Collaborative Design Tool',
      accentColor: '#fb923c',
      gradFrom: '#ea580c',
      gradTo: '#c2410c',
      logoChar: 'F',
      description: 'Verbinde Design und Entwicklung mit Figma Weave. Erstelle interaktive Prototypen, kollaboriere in Echtzeit und verwalte komplexe Design-Systeme an einem Ort.',
      statValue: 'Echtzeit-Design',
      statLabel: 'für Teams & Creator',
      StatIcon: Layout,
      features: [
        { Icon: Layout, label: 'Kollaborativer UI/UX Workspace', color: '#fb923c' },
        { Icon: Code, label: 'Modernes Design-System & Dev Mode', color: '#22d3ee' },
  ...
  },
  {
    ...
    popup: {
      ...
      gradTo: '#c2410c',
      logoChar: 'F',
      description: 'Verwandle deine Idee in eine fertige App oder Website, ganz ohne Code. Einfach beschreiben, Floot baut es. Von Y Combinator gefördert und #1 Product Hunt des Tages.',
      statValue: 'Y Combinator',
      statLabel: 'gefördert · #1 Product Hunt',
      StatIcon: Zap,
      features: [
      ...
      infoLink: 'https://mdw-floot.netlify.app/',
    },
  },
  {
    name: 'Emergent Lab',
  ...
  },
  {
    ...
    katColor: 'bg-violet-500/10 text-violet-400 border-violet-500/20',
    popup: {
      badge: 'KI Content Marketing',
      accentColor: '#a78bfa',
      gradFrom: '#7c3aed',
      gradTo: '#6d28d9',
      logoChar: 'M',
      description: 'Von der Idee zum fertigen Content, Mirr erstellt Carousels, Blogs und Kurzvideos in deiner eigenen Stimme. Was sonst 5 Tools brauchen, schafft Mirr in 10 Minuten.',
      statValue: '18K+ Unternehmer',
      statLabel: 'vertrauen Mirr · 4.8/5 ★',
      StatIcon: Star,
      features: [
  ...
  },
  {
    ...
    popup: {
      ...
      infoLink: 'https://mdw-appsumo.netlify.app/',
    },
  },
  {
    name: 'Artistly',
  ...
  },
  {
    ...
    katColor: 'bg-violet-500/10 text-violet-400 border-violet-500/20',
    popup: {
      badge: 'Web-Hosting & Domain-Anbieter',
      accentColor: '#a78bfa',
      gradFrom: '#6d28d9',
      gradTo: '#5b21b6',
      logoChar: 'H',
      ...
      infoLink: 'https://mdw-hostinger.netlify.app/',
    },
  },
  {
    name: 'Oakgen.ai',
    ...
    link: 'https://oakgen.ai?ref=MDW26r',
    kategorie: 'KI Allround',
    katColor: 'bg-green-500/10 text-green-400 border-green-500/20',
    popup: {
