...
const programme: Programme[] = [
  ...
  {
    name: 'Pictory',
    beschreibung: 'Videos in Minuten aus Text erstellen – wandle Texte, Blogs, URLs, PPTs und Bilder in professionelle Videos mit KI-Stimmen, Avataren und automatischem Schnitt.',
    link: 'https://pictory.ai',
    kategorie: 'Video mit KI',
    katColor: 'bg-purple-500/10 text-purple-400 border-purple-500/20',
    popup: {
      badge: 'KI Text-zu-Video Tool',
      accentColor: '#c084fc',
      gradFrom: '#9333ea',
      gradTo: '#7e22ce',
      logoChar: 'P',
      description: 'Verwandle Texte, Blogs, URLs und Präsentationen in professionelle Videos – mit KI-Avataren, realistischen Stimmen, automatischen Untertiteln und fertigen Templates.',
      statValue: '4.7/5 auf G2',
      statLabel: 'von Creators weltweit',
      StatIcon: Video,
      features: [
        { Icon: FileText, label: 'Text, Blog & URL zu Video', color: '#c084fc' },
        { Icon: Users, label: 'KI-Avatare & realistische Stimmen', color: '#22d3ee' },
        { Icon: Zap, label: 'Automatischer Schnitt & Untertitel', color: '#fbbf24' },
      ],
      cta: 'Pictory kostenlos starten',
      infoLink: 'https://mdw-pictory.netlify.app/',
    },
  },
  {
    name: 'Creatify Lab',
