    ...
    <footer className="relative bg-[#040810] border-t border-cyan-500/10 mt-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-display font-semibold text-white text-sm mb-4">Leistungen</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-display font-semibold text-white text-sm mb-4">Kontakt</h3>
